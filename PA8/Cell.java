...
*/
  ...
  */
  ...
  /**
  * Returns whether this cell has a larger mass than otherCell according
  * to the specifications of compareTo() from Comparable . The actual value
  * you return is not important as long as the sign (or
  * zeroness) is correct
  * @param otherCell a Cell object
  * @param cellMass mass of the cell
  * @return integer indicating mass comparison
  */
  public int compareTo(Cell otherCell){
    int cellMass = this.mass;
    int otherCellMass = otherCell.getMass();
    if(cellMass > otherCellMass){
      return 1;
    }else if (cellMass==otherCellMass){
      return 0;
    }else{
      return -1;
    }
